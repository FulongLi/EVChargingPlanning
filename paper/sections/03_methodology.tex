...
After clustering, each service zone is optimised independently. This decomposition reduces the effective problem size and produces interpretable local planning regions. The current research code implements a lightweight greedy solver for the MVP, while the documented formulation supports later replacement with a mixed-integer or multi-objective optimiser.
